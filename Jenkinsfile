        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/LuisAlbertoQ/Proyecto_despliege.git'
                }
            }
        }
        stage('Build') {
